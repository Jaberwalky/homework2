...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_vol_result = volume_of_cube(4)
    assert_equal( 64, cube_vol_result )
  end

  # # #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_result = volume_of_sphere(4)
    assert_equal( 268.08, volume_result )
  end

  def test_volume_of_sphere()
    volume_result = volume_of_sphere(10)
    assert_equal( 4188.79, volume_result )
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_to_celsius_result = fahrenheit_to_celsius(60)
    assert_equal(15.56, fahrenheit_to_celsius_result)
  end
